...
enum monitor_id_t {
  ...
  MONITOR_OVLD_BUF_POOL_READS_SYNC_IO_COUNT,
  MONITOR_OVLD_BUF_POOL_READS_SYNC_IO_WAIT_USEC,
  MONITOR_OVLD_BUF_POOL_READS_SYNC_IO_SLOW_COUNT,
  MONITOR_OVLD_BUF_POOL_READS_SYNC_IO_SLOW_WAIT_USEC,
